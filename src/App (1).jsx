      ...
      <main style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",
          ...
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            {view==="map" && <>
              ...
              <div style={{display:"flex",alignItems:"center",gap:4,background:"#0f172a",
                border:"1px solid #334155",borderRadius:8,padding:"4px 8px"}}>
                <button style={{...S.zoomBtn}} onClick={zoomOut} title="Zoom Out">−</button>
                ...
                <button style={{...S.zoomBtn,fontSize:10}} onClick={zoomReset} title="Reset">↺</button>
              </div>
        ...
        {view==="map" && (
          <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
            <div ref={mapRef}
              style={{flex:1,position:"relative",overflow:"hidden",cursor:"crosshair",background:"#0f172a"}}
...
const S = {
  ...
  zoomBtn: { padding:"2px 8px",background:"transparent",border:"none",color:"#94a3b8",
             cursor:"pointer",fontSize:18,fontWeight:700,lineHeight:1,borderRadius:4 },
};
